...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--synthetic", action="store_true", help="Generate synthetic data (no Kaggle needed)")
    p.add_argument("--dataset-root", default=None, help="Path to real Kaggle dataset root")
    p.add_argument("--num-shards", type=int, default=8, help="Number of Parquet shards to generate (synthetic only)")
    ...
    p.add_argument("--output-dir", default="./data/synthetic", help="Output directory for synthetic data")
